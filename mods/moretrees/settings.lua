...
moretrees.enable_sequoia		= stg:get_bool("moretrees.enable_sequoia", false)
moretrees.enable_palm			= stg:get_bool("moretrees.enable_palm", false)
...
moretrees.enable_jungle_tree	= stg:get_bool("moretrees.enable_jungle_tree", false)
